...
class HighlightBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = 'pick'
        template = 'mainpage/components/highlight_block.html'
...
# ------------------------------------------------------------------------------
class BlogPage(Page):
    template = 'mainpage/blog/blog_page.html'
...
class BlogIndexPage(Page):
    template = 'mainpage/blog/blog_index.html'
...
class FormPage(AbstractEmailForm):
    template = 'mainpage/forms/basic_form_page.html'
    landing_page_template = 'mainpage/forms/basic_landing_page.html'
